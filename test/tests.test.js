...
[
  ...
  { options: { disablePrefixTrim: true }, querystring: '???a', expected: { '???a': '' } },
  { options: { disablePrefixTrim: true, ignoreQueryPrefix: true }, querystring: '???a', expected: { '??a': '' } },
  { options: { disablePrefixTrim: false }, querystring: '???a', expected: { a: '' } },
  { options: { disablePrefixTrim: false, ignoreQueryPrefix: true }, querystring: '???a', expected: { a: '' } }
].forEach(testData => {
